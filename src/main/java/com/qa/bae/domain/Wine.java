...
public class Wine {
	...
	public Wine(String name, String grape, String description, String tastingNotes, String redOrWhite) {
		super();
		this.name = name;
		this.grape = grape;
	...
	public String getRedOrWhite() {
		return redOrWhite;
	}

	public void setRedOrWhite(String redOrWhite) {
		this.redOrWhite = redOrWhite;
	}
	...
	public String toString() {
		return "Wine [id = " + id + ", name = " + name + ", grape = " + grape + ", description = " + description
				+ ", tastingNotes = " + tastingNotes + ", redOrWhite = " + redOrWhite + ", food = " + food + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((redOrWhite == null) ? 0 : redOrWhite.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (name == null) {
			...
			return false;
		if (redOrWhite == null) {
			if (other.redOrWhite != null)
				return false;
		} else if (!redOrWhite.equals(other.redOrWhite))
			return false;
